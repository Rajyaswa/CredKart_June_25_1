...
class Test_User_Profile_Class:
    ...
    def test_CredKart_Title_001(self):
        ...
        if self.driver.title == "CredKart1":
            ...
            self.driver.save_screenshot(r"C:\Users\SMAK\PycharmProjects\04.CreadKart_Pytest_Framework\ScreenShot\User login Failed.png")
            allure.attach.file(r"C:\Users\SMAK\PycharmProjects\04.CreadKart_Pytest_Framework\ScreenShot\Screenshots\User login Failed.png", name="User login Failed", attachment_type=allure.attachment_type.PNG)
    ...
    def test_CredKart_Registration_003(self):
        ...
        if self.rp.verify_menu() == "Pass":
            ...
            self.log.info("Taking screenshot")
            self.driver.save_screenshot(r"C:\Users\SMAK\PycharmProjects\04.CreadKart_Pytest_Framework\ScreenShot\User Registration Failed.png")
            assert False
